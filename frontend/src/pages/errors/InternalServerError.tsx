...
const InternalServerError = ({ 
  ...
  useEffect(() => {
    console.error("500 Error: Internal Server Error", { message, details, errorId });
  ...
  const handleRefresh = async () => {
    ...
    // Wait a moment before refreshing to show the loading state
    setTimeout(() => {
  ...
  const handleReportError = () => {
    const subject = `Error Report - ${errorId || 'Unknown'}`;
